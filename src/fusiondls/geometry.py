...
class MagneticGeometry(Mapping):
    ...
    def connection_length(self) -> float:
        """Return connection length: the distance from target to midplane"""
    ...
    def scale_flux_expansion(
        ...
        *,
        ...
        name
            Name of the new object, uses old name by default.
    ...
    def scale_connection_length(
        ...
        *,
        ...
        connection length, :math:`L_c`, return a new `MagneticGeometry`.
    ...
    def offset_control_points(
        ...
        Returns an object containing a new ``MagneticGeometry`` and some
        additional data that can be plotted. To access the new profile, use::

            new_geometry = geometry.offset_control_points(offsets).geometry
...
class OffsetControlPointsResult:
    ...
    def plot_control_points(
        ...
        ax.plot(
            self.R_leg_spline, self.Z_leg_spline, **line_args, label=self.geometry.name
        )
        ...
        selector = slice(None, self.geometry.Xpoint)
...
class Morph:
    ...
    def __init__(self, R, Z, Xpoint, Btot, Bpol, Spar, Spol):
        ...
        Needs to be refactored to accept a MagneticGeometry class.
        """
        self.R = R
        self.Z = Z
        self.Xpoint = Xpoint
